...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar la nacionalidad de una atleta por su nombre");
	...
	private void ejecutarNacionalidadAtleta() {
		...
		String paisatl = calculadora.nacionalidadAtleta(nombreAtleta);
		System.out.println("El pais del atleta es...");
		System.out.println(paisatl);
